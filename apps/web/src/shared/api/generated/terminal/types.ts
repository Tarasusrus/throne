...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        TerminalRunMode: "work" | "interview" | "review" | "dream" | "free" | "orchestrator";
        /**
